                   ...
                   <div className="row">
                     ...
                     <div className="col-sm-3">
                       <div className="dynamic-options-actions-buttons">
                         <button onClick={this.addOption.bind(this, index)} className="btn btn-success"><Icon icon="plus-circle" /></button>
                         { index > 0
                           && <button onClick={this.removeOption.bind(this, index)} className="btn btn-danger"><Icon icon="minus-circle" /></button>
                         }
                       </div>
                     </div>
                   </div>
