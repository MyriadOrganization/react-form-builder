...
function ReactFormGenerator(props) {
  ...
  var currentAppLocale = _languageProvider["default"][language]; // Stable, unique-per-mounted-form prefix so element DOM ids (id/htmlFor) and
  ...
  var generatedId = _react["default"].useId();

  var instanceId = props.instanceId || generatedId;
  return /*#__PURE__*/_react["default"].createElement(_reactIntl.IntlProvider, {
    locale: currentAppLocale.locale,
    messages: currentAppLocale.messages
  }, /*#__PURE__*/_react["default"].createElement(_form["default"], (0, _extends2["default"])({}, props, {
