  ...
  function DatePicker(props) {
    ...
    (0, _defineProperty2["default"])(_this, "handleChange", function (dt) {
      ...
      if (dt && dt.target) {
        ...
        formattedDate = dt.target.value ? (0, _dateFns.format)(dt.target.value, formatMask) : "";
        _this.setState({
          value: formattedDate,
          internalValue: formattedDate,
          ...
          var event = {
            target: {
              name: _this.props.data.field_name,
              value: _this.state.value // Use the updated state
            }
          };
          _this.props.handleChange(event);
        });
      } else {
        formattedDate = dt ? (0, _dateFns.format)(dt, formatMask) : "";
        _this.setState({
          value: formattedDate,
          internalValue: dt,
          placeholder: placeholder
  ...
  return (0, _createClass2["default"])(DatePicker, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        selected: this.isValidDate(this.state.internalValue) ? this.state.internalValue : undefined,
        todayButton: "Today",
        className: "form-control",
        isClearable: true,
