...
var TextArea = /*#__PURE__*/function (_React$Component8) {
  ...
  function TextArea(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this4), "updateTextareaHeight", function () {
      var _this4$inputField;

      var textarea = (_this4$inputField = _this4.inputField) === null || _this4$inputField === void 0 ? void 0 : _this4$inputField.current;

      if (textarea) {
        var _textarea$value;

        if ((textarea === null || textarea === void 0 ? void 0 : (_textarea$value = textarea.value) === null || _textarea$value === void 0 ? void 0 : _textarea$value.length) >= 0) {
          textarea.style.height = "";
        }

        if (textarea !== null && textarea !== void 0 && textarea.style) {
          textarea.style.height = (textarea === null || textarea === void 0 ? void 0 : textarea.scrollHeight) + "px"; // Set the height based on content
        }
      }
    });
...
var Checkboxes = /*#__PURE__*/function (_React$Component12) {
  ...
  (0, _createClass2["default"])(Checkboxes, [{
    ...
    value: function render() {
      ...
      var self = this;
      var classNames = "custom-control custom-checkbox"; // if (this.props.mutable) {
