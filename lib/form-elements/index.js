  ...
  (0, _createClass2["default"])(Signature, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        src: sourceDataURL
      }) : /*#__PURE__*/_react["default"].createElement(_reactSignatureCanvas["default"], pad_props), canClear && /*#__PURE__*/_react["default"].createElement("span", {
  ...
  (0, _createClass2["default"])(Checkboxes, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var instancePrefix = _this9.props.instanceId ? "".concat(_this9.props.instanceId.replace(/:/g, ""), "_") : "";
        var this_key = "".concat(instancePrefix, "preview_").concat(option.key);
        var props = {};
  ...
  (0, _createClass2["default"])(RadioButtons, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        var instancePrefix = self.props.instanceId ? "".concat(self.props.instanceId.replace(/:/g, ""), "_") : "";
        var this_key = "".concat(instancePrefix, "preview_").concat(option.key);
        var props = {};
        props.name = "".concat(instancePrefix).concat(self.props.data.field_name);
        props.type = "radio";
        props.value = option.value;
