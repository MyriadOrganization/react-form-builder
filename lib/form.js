...
var MAX_ERROR_LABEL_LENGTH = 60;

var cleanErrorText = function cleanErrorText(value) {
  return String(value).replace(/[\u200B-\u200D\uFEFF]/g, "").replace(/\s+/g, " ").trim();
};

var errorLabel = function errorLabel() {
  var label = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";

  var _DOMParser$parseFromS = new DOMParser().parseFromString(String(label), "text/html"),
      body = _DOMParser$parseFromS.body;

  var text = Array.from(body.childNodes).map(function (node) {
    return cleanErrorText(node.textContent);
  }).find(Boolean) || cleanErrorText(body.textContent);
  return text.length > MAX_ERROR_LABEL_LENGTH ? "".concat(text.slice(0, MAX_ERROR_LABEL_LENGTH).trimEnd(), "\u2026") : text;
};
...
var ReactForm = /*#__PURE__*/function (_React$Component) {
  ...
  function ReactForm(props) {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleChange", function (evt) {
      var whole_response = _this._collectFormData(_this.props.data, false);

      _this.props.onChange && _this.props.onChange(evt, whole_response);
    });
  ...
  (0, _createClass2["default"])(ReactForm, [{
    ...
    value: function _getItemValue(item, ref) {
      var shouldTrim = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
      var $item = {
    ...
    value: function _isIncorrect(item) {
      ...
      if (item.canHaveAnswer) {
        ...
        if (item.element === "Checkboxes" || item.element === "RadioButtons") {
          ...
          item === null || item === void 0 ? void 0 : (_item$options = item.options) === null || _item$options === void 0 ? void 0 : _item$options.forEach(function (option) {
            var _ref$options;

            var $option = _reactDom["default"].findDOMNode(ref === null || ref === void 0 ? void 0 : (_ref$options = ref.options) === null || _ref$options === void 0 ? void 0 : _ref$options["child_ref_".concat(option.key)]);

            if (option !== null && option !== void 0 && option.hasOwnProperty("correct") && !($option !== null && $option !== void 0 && $option.checked) || !(option !== null && option !== void 0 && option.hasOwnProperty("correct")) && $option !== null && $option !== void 0 && $option.checked) {
              incorrect = true;
            }
          });
        } else {
    ...
    value: function _isInvalid(item) {
      ...
      if (item.required === true) {
        ...
        if (item.element === "Checkboxes" || item.element === "RadioButtons") {
          ...
          item === null || item === void 0 ? void 0 : (_item$options2 = item.options) === null || _item$options2 === void 0 ? void 0 : _item$options2.forEach(function (option) {
            var _ref$options2;

            var $option = _reactDom["default"].findDOMNode(ref === null || ref === void 0 ? void 0 : (_ref$options2 = ref.options) === null || _ref$options2 === void 0 ? void 0 : _ref$options2["child_ref_".concat(option.key)]);
          ...
          } else if ($item.value === undefined || ((_$item$value = $item.value) === null || _$item$value === void 0 ? void 0 : _$item$value.length) < 1) {
            invalid = true;
          }
        }
      }
    ...
    value: function _collect(item) {
      var shouldTrim = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
      var itemData = {
      ...
      if (item.element === "Checkboxes" || item.element === "RadioButtons") {
        ...
        var checked_options = [];
        item === null || item === void 0 ? void 0 : (_item$options3 = item.options) === null || _item$options3 === void 0 ? void 0 : _item$options3.forEach(function (option) {
          var _ref$options3;

          var $option = _reactDom["default"].findDOMNode(ref === null || ref === void 0 ? void 0 : (_ref$options3 = ref.options) === null || _ref$options3 === void 0 ? void 0 : _ref$options3["child_ref_".concat(option === null || option === void 0 ? void 0 : option.key)]);

          if ($option !== null && $option !== void 0 && $option.checked) {
            checked_options.push(option === null || option === void 0 ? void 0 : option.key);
          }
        });
    ...
    value: function _collectFormData(data) {
      ...
      data === null || data === void 0 ? void 0 : data.forEach(function (item) {
        var item_data = _this3._collect(item, shouldTrim);
    ...
    value: function validateForm() {
      ...
      (_data_items = data_items) === null || _data_items === void 0 ? void 0 : _data_items.forEach(function (item) {
        ...
        if (_this4._isInvalid(item)) {
          errors.push("".concat(errorLabel(item.label), " ").concat(intl.formatMessage({
    ...
    value: function render() {
      ...
      (_data_items2 = data_items) === null || _data_items2 === void 0 ? void 0 : _data_items2.forEach(function (item) {
      ...
      var items = (_data_items3 = data_items) === null || _data_items3 === void 0 ? void 0 : (_data_items3$filter = _data_items3.filter(function (x) {
        return !x.parentId;
      })) === null || _data_items3$filter === void 0 ? void 0 : _data_items3$filter.map(function (item) {
        if (!item) return null;
        ...
        switch (item.element) {
          ...
          case "Checkboxes":
            return /*#__PURE__*/_react["default"].createElement(Checkboxes, {
              ...
              key: "form_".concat(item.id),
              data: item,
              instanceId: _this8.props.instanceId,
