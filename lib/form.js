...
var _customElement = _interopRequireDefault(
  ...
  (0, _createClass2["default"])(ReactForm, [
      ...
      value: function _isIncorrect(item) {
        ...
        if (item.canHaveAnswer) {
          ...
          if (
            ...
            item.options.forEach(function (option) {
              var $option = _reactDom["default"].findDOMNode(
                ref.options["child_ref_".concat(option.key)]
              );
    ...
    },
    {
      ...
      value: function _getSignatureImg(item) {
        ...
        if ($canvas_sig) {
          ...
          var $input_sig = _reactDom["default"].findDOMNode(
    ...
    },
    {
      ...
      value: function handleSubmit(e) {
        e.preventDefault();
        console.log(
          "handle submit inside the form builder library",
          e,
          this.props
        );
        var errors = [];
