  ...
  return (0, _createClass2["default"])(ReactForm, [{
    ...
    value: function _isIncorrect(item) {
      ...
      if (item.canHaveAnswer) {
        ...
        if (item.element === "Checkboxes" || item.element === "RadioButtons") {
          var _item$options;
          item === null || item === void 0 || (_item$options = item.options) === null || _item$options === void 0 || _item$options.forEach(function (option) {
            var _ref$options;
            var $option = _reactDom["default"].findDOMNode(ref === null || ref === void 0 || (_ref$options = ref.options) === null || _ref$options === void 0 ? void 0 : _ref$options["child_ref_".concat(option.key)]);
    ...
    value: function _isInvalid(item) {
      ...
      if (item.required === true) {
        ...
        if (item.element === "Checkboxes" || item.element === "RadioButtons") {
          ...
          item === null || item === void 0 || (_item$options2 = item.options) === null || _item$options2 === void 0 || _item$options2.forEach(function (option) {
            var _ref$options2;
            var $option = _reactDom["default"].findDOMNode(ref === null || ref === void 0 || (_ref$options2 = ref.options) === null || _ref$options2 === void 0 ? void 0 : _ref$options2["child_ref_".concat(option.key)]);
    ...
    value: function _collect(item) {
      ...
      if (item.element === "Checkboxes" || item.element === "RadioButtons") {
        var _item$options3;
        var checked_options = [];
        item === null || item === void 0 || (_item$options3 = item.options) === null || _item$options3 === void 0 || _item$options3.forEach(function (option) {
          var _ref$options3;
          var $option = _reactDom["default"].findDOMNode(ref === null || ref === void 0 || (_ref$options3 = ref.options) === null || _ref$options3 === void 0 ? void 0 : _ref$options3["child_ref_".concat(option === null || option === void 0 ? void 0 : option.key)]);
          if ($option !== null && $option !== void 0 && $option.checked) {
    ...
    value: function render() {
      ...
      (_data_items2 = data_items) === null || _data_items2 === void 0 || _data_items2.forEach(function (item) {
      ...
      var items = (_data_items3 = data_items) === null || _data_items3 === void 0 || (_data_items3 = _data_items3.filter(function (x) {
        return !x.parentId;
      })) === null || _data_items3 === void 0 ? void 0 : _data_items3.map(function (item) {
        if (!item) return null;
        switch (item.element) {
          case "TextInput":
          case "EmailInput":
