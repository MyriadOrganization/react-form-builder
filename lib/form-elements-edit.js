...
var FormElementsEdit = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(FormElementsEdit, [{
    ...
    value: function onEditorStateChange(index, property, editorContent) {
      var html = (0, _draftjsToHtml["default"])((0, _draftJs.convertToRaw)(editorContent.getCurrentContent())).replace(/<p>/g, "<div>").replace(/<\/p>/g, "</div>"); // const html = draftToHtml(convertToRaw(editorContent.getCurrentContent()))
      //   .replace(/<p>/g, "")
      //   .replace(/<\/p>/g, "")
      //   .replace(/&nbsp;/g, " ")
      //   .replace(/(?:\r\n|\r|\n)/g, " ");
