...
var FormElementsEdit = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(FormElementsEdit, [{
    ...
    key: "editArrayProp",
    value: function editArrayProp(elemProperty, index, e) {
      var this_element = this.state.element;
      var list = Array.isArray(this_element[elemProperty]) ? (0, _toConsumableArray2["default"])(this_element[elemProperty]) : [];
    ...
    value: function onEditorStateChange(index, property, editorContent) {
      var html = (0, _draftjsToHtml["default"])((0, _draftJs.convertToRaw)(editorContent.getCurrentContent())).replace(/<p><\/p>/g, "<div>&zwnj;</div>").replace(/<p>/g, "<div>").replace(/<\/p>/g, "</div>"); // const html = draftToHtml(convertToRaw(editorContent.getCurrentContent()))
      //   .replace(/<p>/g, "")
      //   .replace(/<\/p>/g, "")
      //   .replace(/&nbsp;/g, " ")
      //   .replace(/(?:\r\n|\r|\n)/g, " ");
    ...
    value: function render() {
      ...
      var this_table_columns = Math.min(Math.max(parseInt(this.props.element.columns, 10) || 0, 0), 12);
      var this_table_rows = Math.min(Math.max(parseInt(this.props.element.rows, 10) || 0, 0), 50);
      ...
      return /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }, this.props.element.text), /*#__PURE__*/_react["default"].createElement("div", {
      ...
      }))), this.props.element.hasOwnProperty("rows") && this.props.element.hasOwnProperty("columns") && /*#__PURE__*/_react["default"].createElement("div", null, /*#__PURE__*/_react["default"].createElement("div", {
        className: "row"
        ...
        onBlur: this.updateElement.bind(this),
        onChange: this.editElementProp.bind(this, "columns", "value")
      }))), this_table_columns > 0 && /*#__PURE__*/_react["default"].createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/_react["default"].createElement("label", {
        className: "control-label"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        ...
        length: this_table_columns
      }, function (_, i) {
        var _this4$props$element$;

        return /*#__PURE__*/_react["default"].createElement("input", {
          type: "text",
          key: "column_header_".concat(i),
          className: "form-control",
          style: {
            marginBottom: 8
          },
          defaultValue: (_this4$props$element$ = _this4.props.element.column_headers) === null || _this4$props$element$ === void 0 ? void 0 : _this4$props$element$[i],
          onBlur: _this4.updateElement.bind(_this4),
          onChange: _this4.editArrayProp.bind(_this4, "column_headers", i)
        });
      })), this_table_rows > 0 && /*#__PURE__*/_react["default"].createElement("div", {
        className: "form-group"
      }, /*#__PURE__*/_react["default"].createElement("label", {
        className: "control-label"
      }, /*#__PURE__*/_react["default"].createElement(_IntlMessages["default"], {
        ...
        length: this_table_rows
      }, function (_, i) {
        var _this4$props$element$2;

        return /*#__PURE__*/_react["default"].createElement("input", {
          type: "text",
          key: "row_label_".concat(i),
          className: "form-control",
          style: {
            marginBottom: 8
          },
          defaultValue: (_this4$props$element$2 = _this4.props.element.row_labels) === null || _this4$props$element$2 === void 0 ? void 0 : _this4$props$element$2[i],
          onBlur: _this4.updateElement.bind(_this4),
          onChange: _this4.editArrayProp.bind(_this4, "row_labels", i)
        });
