  ...
  (0, _createClass2["default"])(MultiColumnRow, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        className: "row ".concat(childItems.length === 4 ? "four-column" : childItems.length === 3 ? "three-column" : childItems.length === 2 ? "two-column" : "")
      }, childItems.map(function (x, i) {
        return /*#__PURE__*/_react["default"].createElement("div", {
          key: "".concat(i, "_").concat(x || "_"),
          className: "".concat(className, " shared-input")
...
var TwoColumnRow = function TwoColumnRow(_ref) {
  ...
  var className = [class_name || "two-column"];
...
var ThreeColumnRow = function ThreeColumnRow(_ref2) {
  ...
  var className = class_name || "three-column";
