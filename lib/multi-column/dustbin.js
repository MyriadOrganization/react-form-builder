...
function getElement(item, props) {
  if (!item) return null;
  var Element = item !== null && item !== void 0 && item.custom ? function () {
...
var Dustbin = /*#__PURE__*/_react["default"].forwardRef(function (_ref, ref) {
  ...
  var isDropTarget = !sameCard && isOver && canDrop && !draggedItem.data.isContainer;
  return connectDropTarget( /*#__PURE__*/_react["default"].createElement("div", {
    className: (0, _classnames["default"])("shared-input", "rfb-dustbin", {
